...
def mock_api_client():
    ...
    client.update.return_value = {"instance_id": "res-123", "new_instance_name": "test-ecs_instance-updated"}
...
class TestListEcsInstance:
    ...
    def test_list_with_filter(self, mock_api_client):
        ...
        result = mock_api_client.list("ecs_instance", filters={"new_instance_name": "match"})
        assert len(result) == 1
