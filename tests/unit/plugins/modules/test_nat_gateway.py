...
def mock_api_client():
    ...
    client.update.return_value = {"nat_gateway_id": "res-123", "name": "test-nat_gateway-updated"}
...
class TestListNatGateway:
    ...
    def test_list_with_filter(self, mock_api_client):
        ...
        result = mock_api_client.list("nat_gateway", filters={"name": "match"})
        assert len(result) == 1
