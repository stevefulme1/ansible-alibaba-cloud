...
short_description: Query cas certificate resources.
description:
  - Retrieve information about Alibaba Cloud cas certificate resources.
...
EXAMPLES = r"""
- name: List all cas certificate resources
...
RETURN = r"""
cas_certificates:
  description: List of cas certificate resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("CertificateOrderList", {})
    data = data.get("CertificateOrder", {})
