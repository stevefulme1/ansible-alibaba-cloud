...
short_description: Query ecs security group rule resources.
description:
  - Retrieve information about Alibaba Cloud ecs security group rule resources.
...
EXAMPLES = r"""
- name: List all ecs security group rule resources
...
ecs_security_group_rules:
  description: List of ecs security group rule resources.
  returned: success
  type: list
  elements: dict
"""
