...
short_description: Query ecs auto scaling group resources.
description:
  - Retrieve information about Alibaba Cloud ecs auto scaling group resources.
...
EXAMPLES = r"""
- name: List all ecs auto scaling group resources
...
ecs_auto_scaling_groups:
  description: List of ecs auto scaling group resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("ScalingGroups", {})
    data = data.get("ScalingGroup", {})
