...
short_description: Query dcdn ipa domain resources.
description:
  - Retrieve information about Alibaba Cloud dcdn ipa domain resources.
...
EXAMPLES = r"""
- name: List all dcdn ipa domain resources
...
RETURN = r"""
dcdn_ipa_domains:
  description: List of dcdn ipa domain resources.
  returned: success
  type: list
  elements: dict
"""
