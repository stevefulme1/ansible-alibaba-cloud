...
short_description: Query directmail sender resources.
description:
  - Retrieve information about Alibaba Cloud directmail sender resources.
...
EXAMPLES = r"""
- name: List all directmail sender resources
...
RETURN = r"""
directmail_senders:
  description: List of directmail sender resources.
  returned: success
  type: list
  elements: dict
"""
