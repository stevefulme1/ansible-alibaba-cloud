...
short_description: Query alidns gtm instance resources.
description:
  - Retrieve information about Alibaba Cloud alidns gtm instance resources.
...
EXAMPLES = r"""
- name: List all alidns gtm instance resources
...
alidns_gtm_instances:
  description: List of alidns gtm instance resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("GtmInstances", {})
    data = data.get("GtmInstance", {})
