...
short_description: Query waf domain resources.
description:
  - Retrieve information about Alibaba Cloud waf domain resources.
...
EXAMPLES = r"""
- name: List all waf domain resources
...
RETURN = r"""
waf_domains:
  description: List of waf domain resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("DomainNames", {})
    data = data.get("DomainName", {})
