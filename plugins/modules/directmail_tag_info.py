...
short_description: Query directmail tag resources.
description:
  - Retrieve information about Alibaba Cloud directmail tag resources.
...
EXAMPLES = r"""
- name: List all directmail tag resources
...
RETURN = r"""
directmail_tags:
  description: List of directmail tag resources.
  returned: success
  type: list
  elements: dict
"""
