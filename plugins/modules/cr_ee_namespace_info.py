...
short_description: Query cr ee namespace resources.
description:
  - Retrieve information about Alibaba Cloud cr ee namespace resources.
...
EXAMPLES = r"""
- name: List all cr ee namespace resources
...
RETURN = r"""
cr_ee_namespaces:
  description: List of cr ee namespace resources.
  returned: success
  type: list
  elements: dict
"""
