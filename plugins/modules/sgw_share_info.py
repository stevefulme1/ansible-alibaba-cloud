...
short_description: Query sgw share resources.
description:
  - Retrieve information about Alibaba Cloud sgw share resources.
...
EXAMPLES = r"""
- name: List all sgw share resources
...
RETURN = r"""
sgw_shares:
  description: List of sgw share resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("FileShares", {})
    data = data.get("FileShare", {})
