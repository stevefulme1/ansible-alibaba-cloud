...
short_description: Query dms user resources.
description:
  - Retrieve information about Alibaba Cloud dms user resources.
...
EXAMPLES = r"""
- name: List all dms user resources
...
RETURN = r"""
dms_users:
  description: List of dms user resources.
  returned: success
  type: list
  elements: dict
"""
