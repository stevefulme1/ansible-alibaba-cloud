...
short_description: Query RAM access keys.
description:
  - Retrieve information about Alibaba Cloud RAM access keys.
version_added: "1.0.0"
...
options:
  user_name:
    description: RAM user to query keys for.
    type: str
"""

EXAMPLES = r"""
- name: Query RAM access keys for a user
...
RETURN = r"""
ram_access_keys:
  description: List of RAM access keys.
  returned: success
  type: list
  elements: dict
"""
