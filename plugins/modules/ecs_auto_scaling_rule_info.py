...
short_description: Query ecs auto scaling rule resources.
description:
  - Retrieve information about Alibaba Cloud ecs auto scaling rule resources.
...
EXAMPLES = r"""
- name: List all ecs auto scaling rule resources
  stevefulme1.alibaba_cloud.ecs_auto_scaling_rule_info:
    access_key_id: "{{ ak }}"
    access_key_secret: "{{ sk }}"
    region_id: cn-hangzhou
    scaling_group_id: example-value
"""

RETURN = r"""
ecs_auto_scaling_rules:
  description: List of ecs auto scaling rule resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("ScalingRules", {})
    data = data.get("ScalingRule", {})
