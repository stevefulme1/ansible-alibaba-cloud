...
short_description: Query config delivery channel resources.
description:
  - Retrieve information about Alibaba Cloud config delivery channel resources.
...
EXAMPLES = r"""
- name: List all config delivery channel resources
...
config_delivery_channels:
  description: List of config delivery channel resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("DeliveryChannels", {})
    data = data.get("DeliveryChannel", {})
