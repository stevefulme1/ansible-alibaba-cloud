...
"""Ansible module: stevefulme1.alibaba_cloud.ram_user_policy_attachment"""
...
short_description: Attach policies to users.
description:
  - Create, update, or delete Alibaba Cloud ram_user_policy_attachment resources.
...
- name: Attach policy to user
  stevefulme1.alibaba_cloud.ram_user_policy_attachment:
    access_key_id: "{{ ak }}"
