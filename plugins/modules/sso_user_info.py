...
short_description: Query sso user resources.
description:
  - Retrieve information about Alibaba Cloud sso user resources.
...
EXAMPLES = r"""
- name: List all sso user resources
...
RETURN = r"""
sso_users:
  description: List of sso user resources.
  returned: success
  type: list
  elements: dict
"""
