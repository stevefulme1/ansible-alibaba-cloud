...
short_description: Query PolarDB database accounts.
description:
  - Retrieve information about Alibaba Cloud PolarDB database accounts.
version_added: "1.0.0"
...
options:
  db_cluster_id:
    ...
    required: true
  account_name:
    description: Filter by database account name.
    type: str
"""

EXAMPLES = r"""
- name: Query all PolarDB accounts in a cluster
...
- name: Query specific PolarDB account
  stevefulme1.alibaba_cloud.polardb_account_info:
    access_key_id: "{{ ak }}"
    access_key_secret: "{{ sk }}"
    region_id: cn-hangzhou
...
RETURN = r"""
polardb_accounts:
  description: List of PolarDB database accounts.
  returned: success
  type: list
  elements: dict
"""
