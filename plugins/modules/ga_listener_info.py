...
short_description: Query ga listener resources.
description:
  - Retrieve information about Alibaba Cloud ga listener resources.
...
options:
  accelerator_id:
    description: Filter by accelerator id.
    type: str
  limit:
    description:
...
EXAMPLES = r"""
- name: List all ga listener resources
  stevefulme1.alibaba_cloud.ga_listener_info:
    access_key_id: "{{ ak }}"
    access_key_secret: "{{ sk }}"
    region_id: cn-hangzhou
    accelerator_id: example-value
"""

RETURN = r"""
ga_listeners:
  description: List of ga listener resources.
  returned: success
  type: list
  elements: dict
"""
