...
short_description: Query directmail domain resources.
description:
  - Retrieve information about Alibaba Cloud directmail domain resources.
...
EXAMPLES = r"""
- name: List all directmail domain resources
...
RETURN = r"""
directmail_domains:
  description: List of directmail domain resources.
  returned: success
  type: list
  elements: dict
"""
