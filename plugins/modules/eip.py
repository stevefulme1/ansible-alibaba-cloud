...
"""Ansible module: stevefulme1.alibaba_cloud.eip"""
...
---
module: eip
short_description: Manage Elastic IPs.
description:
  - Create, update, or delete Alibaba Cloud eip resources.
...
options:
  ...
  bandwidth:
    ...
    default: 5
  allocation_id:
    description: Existing EIP allocation ID (for delete).
    type: str
"""

EXAMPLES = r"""
- name: Allocate EIP
  stevefulme1.alibaba_cloud.eip:
    access_key_id: "{{ ak }}"
