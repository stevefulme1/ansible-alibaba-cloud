...
short_description: Query redis whitelist resources.
description:
  - Retrieve information about Alibaba Cloud redis whitelist resources.
...
EXAMPLES = r"""
- name: List all redis whitelist resources
...
RETURN = r"""
redis_whitelists:
  description: List of redis whitelist resources.
  returned: success
  type: list
  elements: dict
"""
