...
short_description: Query mqtt topic resources.
description:
  - Retrieve information about Alibaba Cloud mqtt topic resources.
...
EXAMPLES = r"""
- name: List all mqtt topic resources
...
RETURN = r"""
mqtt_topics:
  description: List of mqtt topic resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    try:
        result = client.get(
            "ListGroupId",
            params,
            service_endpoint="onsmqtt.{region_id}.aliyuncs.com".replace("{region_id}", module.params["region_id"]),
