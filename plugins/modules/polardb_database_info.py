...
short_description: Query polardb database resources.
description:
  - Retrieve information about Alibaba Cloud polardb database resources.
...
EXAMPLES = r"""
- name: List all polardb database resources
...
RETURN = r"""
polardb_databases:
  description: List of polardb database resources.
  returned: success
  type: list
  elements: dict
"""
