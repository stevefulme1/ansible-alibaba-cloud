...
"""Ansible module: stevefulme1.alibaba_cloud.redis_backup"""
...
---
module: redis_backup
short_description: Manage Redis backups.
description:
  - Create or delete backups for an Alibaba Cloud Redis instance.
...
EXAMPLES = r"""
- name: Manage Redis backups
  stevefulme1.alibaba_cloud.redis_backup:
    access_key_id: "{{ ak }}"
