...
short_description: Query security group egress rules.
description:
  - Retrieve information about Alibaba Cloud security group egress rules.
version_added: "1.0.0"
...
EXAMPLES = r"""
- name: Query security group egress rules
