...
short_description: Query kms secret resources.
description:
  - Retrieve information about Alibaba Cloud kms secret resources.
...
EXAMPLES = r"""
- name: List all kms secret resources
...
RETURN = r"""
kms_secrets:
  description: List of kms secret resources.
  returned: success
  type: list
  elements: dict
"""
