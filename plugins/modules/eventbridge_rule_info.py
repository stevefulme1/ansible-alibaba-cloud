...
short_description: Query eventbridge rule resources.
description:
  - Retrieve information about Alibaba Cloud eventbridge rule resources.
...
EXAMPLES = r"""
- name: List all eventbridge rule resources
  stevefulme1.alibaba_cloud.eventbridge_rule_info:
    access_key_id: "{{ ak }}"
    access_key_secret: "{{ sk }}"
    region_id: cn-hangzhou
    event_bus_name: example-value
"""

RETURN = r"""
eventbridge_rules:
  description: List of eventbridge rule resources.
  returned: success
  type: list
  elements: dict
"""
