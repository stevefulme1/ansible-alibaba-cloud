...
short_description: Query dns domain resources.
description:
  - Retrieve information about Alibaba Cloud dns domain resources.
...
EXAMPLES = r"""
- name: List all dns domain resources
...
RETURN = r"""
dns_domains:
  description: List of dns domain resources.
  returned: success
  type: list
  elements: dict
"""
