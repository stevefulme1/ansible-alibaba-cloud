...
short_description: Query mongodb backup resources.
description:
  - Retrieve information about Alibaba Cloud mongodb backup resources.
...
EXAMPLES = r"""
- name: List all mongodb backup resources
