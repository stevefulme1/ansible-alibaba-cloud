...
short_description: Query rds readonly instance resources.
description:
  - Retrieve information about Alibaba Cloud rds readonly instance resources.
...
EXAMPLES = r"""
- name: List all rds readonly instance resources
...
rds_readonly_instances:
  description: List of rds readonly instance resources.
  returned: success
  type: list
  elements: dict
"""
