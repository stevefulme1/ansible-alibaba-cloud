...
short_description: Query resource manager resource group resources.
description:
  - Retrieve information about Alibaba Cloud resource manager resource group resources.
...
EXAMPLES = r"""
- name: List all resource manager resource group resources
...
resource_manager_resource_groups:
  description: List of resource manager resource group resources.
  returned: success
  type: list
  elements: dict
"""
