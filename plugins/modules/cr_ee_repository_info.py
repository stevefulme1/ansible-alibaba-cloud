...
short_description: Query cr ee repository resources.
description:
  - Retrieve information about Alibaba Cloud cr ee repository resources.
...
EXAMPLES = r"""
- name: List all cr ee repository resources
...
RETURN = r"""
cr_ee_repositories:
  description: List of cr ee repository resources.
  returned: success
  type: list
  elements: dict
"""
