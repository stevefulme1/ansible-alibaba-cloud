...
short_description: Query hbr backup plan resources.
description:
  - Retrieve information about Alibaba Cloud hbr backup plan resources.
...
EXAMPLES = r"""
- name: List all hbr backup plan resources
...
RETURN = r"""
hbr_backup_plans:
  description: List of hbr backup plan resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("BackupPlans", {})
    data = data.get("BackupPlan", {})
