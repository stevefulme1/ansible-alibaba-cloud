...
short_description: Query alidns gtm address pool resources.
description:
  - Retrieve information about Alibaba Cloud alidns gtm address pool resources.
...
EXAMPLES = r"""
- name: List all alidns gtm address pool resources
...
alidns_gtm_address_pools:
  description: List of alidns gtm address pool resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("AddrPools", {})
    data = data.get("AddrPool", {})
