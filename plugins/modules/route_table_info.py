...
short_description: Query route table resources.
description:
  - Retrieve information about Alibaba Cloud route table resources.
...
EXAMPLES = r"""
- name: List all route table resources
...
RETURN = r"""
route_tables:
  description: List of route table resources.
  returned: success
  type: list
  elements: dict
"""
...
def main():
    ...
    data = result
    data = data.get("RouterTableList", {})
    data = data.get("RouterTableListType", {})
