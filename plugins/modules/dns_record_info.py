...
short_description: Query dns record resources.
description:
  - Retrieve information about Alibaba Cloud dns record resources.
...
EXAMPLES = r"""
- name: List all dns record resources
...
RETURN = r"""
dns_records:
  description: List of dns record resources.
  returned: success
  type: list
  elements: dict
"""
