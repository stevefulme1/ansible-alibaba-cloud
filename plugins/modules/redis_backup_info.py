...
short_description: Query redis backup resources.
description:
  - Retrieve information about Alibaba Cloud redis backup resources.
...
EXAMPLES = r"""
- name: List all redis backup resources
...
RETURN = r"""
redis_backups:
  description: List of redis backup resources.
  returned: success
  type: list
  elements: dict
"""
